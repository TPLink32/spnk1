...
################################################################################
# cefout: these settings are prefaced by the [cefout] stanza
################################################################################
[cefout]
inline = [1|0]
...
###### Appendix A: cefout fieldmap Specification #######
...
#                   
#{        
#    "version":           "<fieldmap specification version number>",
#	 "fieldmap":          {
...
#                       },
#        "<cef_key_2>": {"cef_value_type": "<fieldmap|userdefined>",
#                        "splunk_key":     "<splunk field name where cef_value_type=fieldmap>",
#                        "cef_value":      "<value where cef_value_type=userdefined>",
#                        "time_format":    "<time format>"
#                       },
