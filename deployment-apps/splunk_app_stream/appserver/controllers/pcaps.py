...
class Pcaps(controllers.BaseController):
    ...
    def handle_error(self, capture_bucket_date, flow_id, orig_kwargs, err_text, overrides={}):
        ...
        logger.error("Pcaps.handle_error: capture_bucket_date = %s, flow_id = %s, kwargs = %s" % (capture_bucket_date, flow_id, orig_kwargs))
    ...
    def get_file(self, capture_bucket_date='', flow_id='', **kwargs):
        ...
        logger.debug("Pcaps.get_file: capture_bucket_date = %s, flow_id = %s, kwargs = %s" % (capture_bucket_date, flow_id, kwargs))
        ...
        logger.debug("Pcaps.get_file: result = %s" % str(result))
