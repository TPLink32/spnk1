...
def make_kvstore_url(splunk_proxy, namespace, collection):
    """
    ...
    Args:
        ...
        collection (str): the namve of the KVStore collection to query
    ...
    return make_splunk_url(splunk_proxy, namespace, extra_url_parts=url_parts, url_params=url_params)
