...
from lookups.lookups_util import get_lookups_from_splunk
...
def list_models(searchinfo, query_params=None):
    ...
    lookup_files = get_lookups_from_splunk(searchinfo, '-', models_util.parse_reply, query_params=query_params)
