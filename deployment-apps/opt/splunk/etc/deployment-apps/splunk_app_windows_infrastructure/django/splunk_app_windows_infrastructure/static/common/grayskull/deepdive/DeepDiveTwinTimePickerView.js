requirejs.config({
    paths: {
        'app-contrib': 'common/grayskull/common/contrib',
        'app-common': 'common/grayskull/common',
        'app-components': 'common/grayskull',
        'text': './contrib/text'
    }
});
define([
		...
		'app-common/controls/datetimepicker/DateTimePickerView',
		'app-components/deepdive/DeepDiveUtils',
		'text!app-components/deepdive/DeepDiveTwinTimePickerView.html',
		'css!app-components/deepdive/DeepDiveTwinTimePickerView.css'
	],
	function (
		$,
		_,
