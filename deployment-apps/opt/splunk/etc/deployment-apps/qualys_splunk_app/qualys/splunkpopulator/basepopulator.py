...
from qualys.splunkpopulator.utils import QualysAPIClient
from qualys import *
import qualys
from qualys.lib import api
...
class BasePopulator():
    ...
    def __init__(self, logging_handler=None):
        ...
        :rtype : BasePopulator
        """
        assert isinstance(qapi.client, qualys.lib.api.Client.APIClient)
    ...
    def _parse(self, file_name):
        ...
        if load_next_batch and next_url is not None:
            ...
            next_batch_params = qualys.splunkpopulator.utils.get_params_from_url(next_url.text)
