        ...
        render: function () {
            ...
            **/
            ...
            var topApps = new SearchManager({
                ...
                "status_buckets": 0,
                "search": "index=* source=\"stream:Splunk_Tcp\" OR source=\"stream:Splunk_Udp\" | stats sum(sum(bytes)) as Bytes by app | sort - Bytes | head 20 | rename app AS \"Application\" | table Application, Bytes",
                "sample_ratio": null,
                "latest_time": "$latest$",
                "cancelOnUnload": true,
            ...
            **/
            ...
            var responseTimesSM = new SearchManager({
                                ...
                                "earliest_time": "$earliest$",
                                "latest_time": "$latest$",
                                "search": 'index=* eventtype=stream_agg_databases query!="" ' +
            ...
            var maxResponseTime = new PostProcessManager({
                                  "id": "maxResponseTime",
                                  "managerid": "responseTimesSM",
                                  "status_buckets": 0,
                                  "earliest_time": "$earliest$",
                                  "latest_time": "$latest$",
                                  "search": ' stats sparkline(max(time_taken)) as "Response Time (μs)" by sourcetype',
                                  "auto_cancel": 90,
                                  "preview": true,
                                  }, {tokens: true, tokenNamespace: "submitted"});
            ...
            **/
            ...
            var avgResponseTimeSM = new PostProcessManager({
                                    "id": "avgResponseTime",
                                    "managerid": "responseTimesSM",
                                    "status_buckets": 0,
                                    "earliest_time": "$earliest$",
                                    "latest_time": "$latest$",
                                    "search": ' stats sparkline(avg(time_taken)) as "Response Time (μs)" by sourcetype',
                                    "cancelOnUnload": true,
                                    "app": utils.getCurrentApp(),
                                    "auto_cancel": 90,
                                    "preview": true,
            ...
            **/
            ...
            var sslActivitySM = new SearchManager({
                ...
                "earliest_time": "$earliest$",
                "latest_time": "$latest$",
                "search": 'index=* source=stream:Splunk_SSLActivity ssl_subject_common_name!=NULL | stats sum(count) as Count by ssl_subject_common_name | head 999',
                "cancelOnUnload": true,
                "app": utils.getCurrentApp(),
                "auto_cancel": 90,
                "preview": true,
