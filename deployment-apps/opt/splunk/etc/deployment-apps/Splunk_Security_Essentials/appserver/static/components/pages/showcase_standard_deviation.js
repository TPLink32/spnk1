...
require(["jquery",
    ...
    $(".hideable").each(function(index, value){ var id="random_id_" + Math.random().toString(36).replace(/[^a-z]+/g, '').substr(0, 5); $(value).attr("id", id); console.log("setting div to id", $(value), id); $(value).parent().prepend("<p><a href=\"#\" onclick='$(\"#" + id + "\").toggle(); return false;'>Toggle Help</a></p>"); $(value).toggle(); })
                    ...
                    (function () {
                        ...
                        outliersVizAlertModal.footer.append($('<button>').addClass('mlts-modal-cancel').attr({
                            ...
                            if (isValid) {
                                ...
                                if(typeof window.actions.createUBA != "undefined"){ console.log("ParamBeingSet", window.actions.createUBA); alertModal.model.alert.entry.content.set('action.send2uba', window.actions.createUBA);}
                                if(typeof window.actions.UBASeverity != "undefined"){ console.log("ParamBeingSet", window.actions.UBASeverity);  alertModal.model.alert.entry.content.set('action.send2uba.param.severity', window.actions.UBASeverity); }
                                if(typeof window.actions.createNotable != "undefined"){  console.log("ParamBeingSet", window.actions.createNotable); alertModal.model.alert.entry.content.set('action.notable', window.actions.createNotable); }
                                if(typeof window.actions.createRisk != "undefined"){ console.log("ParamBeingSet", window.actions.createRisk);  alertModal.model.alert.entry.content.set('action.risk', window.actions.createRisk); }
                                if(typeof window.actions.riskObject != "undefined"){ console.log("ParamBeingSet", window.actions.riskObject);  alertModal.model.alert.entry.content.set('action.risk.param._risk_object', window.actions.riskObject); }
                                if(typeof window.actions.riskObjectType != "undefined"){  console.log("ParamBeingSet", window.actions.riskObjectType); alertModal.model.alert.entry.content.set('action.risk.param._risk_object_type', window.actions.riskObjectType); }
                                if(typeof window.actions.riskObjectScore != "undefined"){  console.log("ParamBeingSet", window.actions.riskObjectScore); alertModal.model.alert.entry.content.set('action.risk.param._risk_score', window.actions.riskObjectScore); }
            ...
            function scheduleHighCardinalityAlert() {
                if (outliersVizAlertModal == null) {
                    ...
                                        });
                                        ...
                                        console.log("About to set Params", window.actions)
                                        if(typeof window.actions.createUBA != "undefined"){ console.log("ParamBeingSet", window.actions.createUBA); secondAlertModal.model.alert.entry.content.set('action.send2uba', window.actions.createUBA);}
                                        if(typeof window.actions.UBASeverity != "undefined"){ console.log("ParamBeingSet", window.actions.UBASeverity);  secondAlertModal.model.alert.entry.content.set('action.send2uba.param.severity', window.actions.UBASeverity); }
                                        if(typeof window.actions.createNotable != "undefined"){  console.log("ParamBeingSet", window.actions.createNotable); secondAlertModal.model.alert.entry.content.set('action.notable', window.actions.createNotable); }
                                        if(typeof window.actions.createRisk != "undefined"){ console.log("ParamBeingSet", window.actions.createRisk);  secondAlertModal.model.alert.entry.content.set('action.risk', window.actions.createRisk); }
                                        if(typeof window.actions.riskObject != "undefined"){ console.log("ParamBeingSet", window.actions.riskObject);  secondAlertModal.model.alert.entry.content.set('action.risk.param._risk_object', window.actions.riskObject); }
                                        if(typeof window.actions.riskObjectType != "undefined"){  console.log("ParamBeingSet", window.actions.riskObjectType); secondAlertModal.model.alert.entry.content.set('action.risk.param._risk_object_type', window.actions.riskObjectType); }
                                        if(typeof window.actions.riskObjectScore != "undefined"){  console.log("ParamBeingSet", window.actions.riskObjectScore); secondAlertModal.model.alert.entry.content.set('action.risk.param._risk_score', window.actions.riskObjectScore); }
    ...
    function setCurrentSampleSearch(sampleSearch) {
        ...
        function process_chosen_summary(summary, override){
            ...
            $("h3:contains(How Does This Detection Work)").parent().append(per_instance_help)
            ...
            console.log("ShowcaseInfo: Here are several fields!", relevance, per_instance_help, description)
                ...
                if(typeof summary.examples != "undefined" && dashboardname == showcaseName){
                    for (var example in summary.examples){
                        if(summary.examples[example].name == sampleSearch.label){
                            process_chosen_summary(summary)
                        }
