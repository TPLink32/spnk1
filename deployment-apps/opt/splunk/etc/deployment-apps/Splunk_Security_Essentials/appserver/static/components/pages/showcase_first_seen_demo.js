...
*/
            ...
            PromptForLookupModal.footer.append($('<button>').addClass('mlts-modal-submit').attr({
                ...
                'data-dismiss': 'modal'
                    ...
                    GetTheLookupNameModal.footer.append($('<button>').addClass('mlts-modal-submit').attr({
                        ...
                        'data-dismiss': 'modal'
                            ...
                            CreateTheLookupModal.body.addClass('mlts-modal-form-inline')
                                .append($('<p>Creating lookup....<br/><br/><div id="StatusMessages" style="margin-left:0px;display:block;"></div><div style="margin-left:0px;display:block;" id="CreateLookupStatus"><center><img src="/static/app/Splunk_Security_Essentials/images/general_images/loader.gif"></center></div></p>'));
                            ...
                            CreateLookup(window.resultant_stanza, function(){
                                ...
                                document.getElementById("CreateLookupStatus").innerHTML = "<img src=\"/static//app/Splunk_Security_Essentials/images/general_images/ok_ico.gif\">"; 
                    ...
                    CheckForAvailable.on('search:error', function(properties) {
                        document.getElementById("resultant_available").innerHTML = "<img title=\"Error\" src=\"/static//app/Splunk_Security_Essentials/images/general_images/err_ico.gif\">"; 
                        $(".mlts-modal-submit:contains(Create)").first()[0].disabled=true
                    ...
                    CheckForAvailable.on('search:done', function(properties) {
                        ...
                        if(CheckForAvailable.attributes.data.resultCount == 0) {
                          document.getElementById("resultant_available").innerHTML = "<img src=\"/static//app/Splunk_Security_Essentials/images/general_images/ok_ico.gif\">"; 
                        ...
                        CheckForAvailableResults.on("data", function(properties) {
                            ...
                            if(data[0].count == 0){
                                document.getElementById("resultant_available").innerHTML = "<img title=\"Error\" src=\"/static//app/Splunk_Security_Essentials/images/general_images/ok_ico.gif\">"; 
                                document.getElementById("resultant_text").innerHTML = "Click Next to create this lookup."; 
                    ...
                    var LookupNameControl = function () {
                        ...
                        LookupNameControl.on('change', function (value) {
                            document.getElementById("resultant_available").innerHTML = '<img src="/static/app/Splunk_Security_Essentials/images/general_images/loader.gif" />'; 
                            $(".mlts-modal-submit:contains(Create)").first()[0].disabled=true
                            if(value.indexOf(".")>0){
    ...
    function CheckData(myDeferred, lookupName){
        ...
        if(parseInt(document.getElementById("StatusCounter").innerHTML) == 2){
            document.getElementById("StatusMessages").innerHTML = document.getElementById("StatusMessages").innerHTML.replace(/Try .*/, "<br/>Usually the fastest thing to get Splunk to recognize the lookup is for you to <a target=\"_blank\" href=\"/app/Splunk_Security_Essentials/search?q=%7C%20inputlookup%20" + lookupName + "%20%7C%20inputlookup%20append%3Dt%20" + lookupName + ".csv&earliest=%40d&latest=now\"><b>click this link</b></a>.<br /><br />Try <span id=\"StatusCounter\">2</span>...<br/>")
        }
