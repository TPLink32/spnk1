define([
    ...
    return Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            this.appDropdownList = new DropdownList({model: this.apps, defaultValue: "Splunk_TA_cisco-ucs"});
            this.apps.fetch();
        ...
        render: function() {
            ...
            this.$("[role=dialog]").on('shown.bs.modal', function() {
                $("#Splunk_TA_cisco-ucs_server_select_panel_table").bootstrapTable({
                    url: splunkdUtils.make_url('custom/Splunk_TA_cisco-ucs/manage_servers/servers')
                });

                $("#Splunk_TA_cisco-ucs_template_select_panel_table").bootstrapTable({
        ...
        addTask: function() {
            var new_task_val = {
                ...
                "disabled" : "0",
                "servers" : this.getSelectionListSelections("#Splunk_TA_cisco-ucs_server_select_panel_table"),
                "templates" : this.getSelectionListSelections("#Splunk_TA_cisco-ucs_template_select_panel_table")
            };
