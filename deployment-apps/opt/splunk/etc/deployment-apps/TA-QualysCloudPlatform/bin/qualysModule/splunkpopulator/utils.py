...
def getCredentials(session_key):
    ...
    try:
        ...
        qualysModule.splunkpopulator.utils.printStreamEventXML("_internal", "Could not get %s credentials from Splunk. Cannot continue. Error: %s" % (myapp, str(e)))
    ...
    qualysModule.splunkpopulator.utils.printStreamEventXML("_internal", "No credentials found. Cannot continue.")
