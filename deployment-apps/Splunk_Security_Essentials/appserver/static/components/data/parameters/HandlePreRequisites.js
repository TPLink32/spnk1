    ...
    return {
            ...
            if(prereqs.length > 0){
                ...
                for(var i = 0; i < prereqs.length; i++){
                    ...
                    $("#data_check_table tr:last").after("<tr><td>" + prereqs[i].name + "</td><td id=\"data_check_test"+ i + "\">Checking...</td><td><a target=\"_blank\" href=\"/app/Splunk_Security_Essentials/search?q="+encodeURI(prereqs[i].test) + "\">Open in Search</a></td><td>" + prereqs[i].resolution + "</td></tr>")
