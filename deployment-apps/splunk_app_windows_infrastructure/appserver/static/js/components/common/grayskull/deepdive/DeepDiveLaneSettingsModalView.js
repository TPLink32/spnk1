define([
    ...
    'css!app-components/deepdive/DeepDiveLaneSettingsModalView.css'
    ],
    function (
    $, 
    _, 
     ...
     * @private
     */
    if (options.laneSettingsCollection instanceof DeepDiveLaneSettingsCollection) {
    this._laneSettingsCollection = options.laneSettingsCollection;
    }
    else {
    this._laneSettingsCollection = null;
    }
    ...
    if (this._laneSettingsCollection instanceof DeepDiveLaneSettingsCollection) {
