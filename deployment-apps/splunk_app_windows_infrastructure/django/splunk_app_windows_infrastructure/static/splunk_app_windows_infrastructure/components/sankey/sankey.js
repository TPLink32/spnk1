...
define(function(require, exports, module) {
    ...
    var d3 = require("/dj/static/splunk_app_windows_infrastructure/components/d3/d3.js");
    var sankey = require("/dj/static/splunk_app_windows_infrastructure/components/sankey/contrib/d3-sankey.js");
    ...
    var SankeyChart = SimpleSplunkView.extend({
        ...
        options: {
            ...
            formatTooltip: function(d) {
                return (d.source.name + ' accessed ' + d.target.name +
        ...
        initialize: function() {
            ...
            $(window).resize(this, _.debounce(this._handleResize.bind(this), 20));
        },
